      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="md:hidden space-y-4">
            {filteredDiaries.map((diary) => (
              <div key={diary.id} className="bg-gray-50 rounded-lg p-4 border">
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-gray-900 truncate">{diary.name}</h3>
                      <div className="flex items-center gap-2 mt-1">
                        <BookOpen className="h-4 w-4 text-gray-400" />
                        <span className="text-sm text-gray-600">{diary.subject.name}</span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600 truncate max-w-32">{diary.teacher.name}</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600">Progresso das aulas</span>
                      <span className="font-medium text-gray-900">
                        {diary.completedLessons}/{diary.totalLessons} ({diary.progressPercentage}%)
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                  ...
                  <div className="flex gap-2 pt-2 border-t border-gray-200">
                    <Button
                      ...
                      className="flex-1 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 justify-center"
                    >
