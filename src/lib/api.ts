...
export const studentApi = {
  ...
  update: (id: number, data: Partial<Student>) => {
    console.log("🐛 DEBUG - studentApi.update payload para ID", id, ":", {
      student: data,
    });
...
export const teacherApi = {
  ...
  update: (id: number, data: any) => {
    console.log("🐛 DEBUG - teacherApi.update payload para ID", id, ":", {
      teacher: data,
    });
...
export const classApi = {
  ...
  update: (id: number, data: Partial<SchoolClass>) => {
    console.log("🐛 DEBUG - classApi.update payload para ID", id, ":", {
      school_class: data,
    });
...
export const lessonApi = {
  ...
  getAttendances: (id: number) =>
    api.get<Attendance[]>(`/lessons/${id}/attendances`),
};
...
export const attendanceApi = {
  ...
  bulkUpdate: (
    attendances: Array<{ id: number; status: string; observation?: string }>,
...
export const occurrenceApi = {
  ...
  update: (id: number, data: Partial<Occurrence>) =>
...
export const salaryApi = {
  ...
  create: (data: Partial<Salary>) =>
    api.post<Salary>("/salaries", { salary: data }),
  update: (id: number, data: Partial<Salary>) =>
    api.put<Salary>(`/salaries/${id}`, { salary: data }),
...
export const tuitionApi = {
  ...
  create: (data: Partial<Tuition>) =>
    api.post<Tuition>("/tuitions", { tuition: data }),
  update: (id: number, data: Partial<Tuition>) =>
    api.put<Tuition>(`/tuitions/${id}`, { tuition: data }),
  delete: (id: number) => api.delete(`/tuitions/${id}`),
  pay: (id: number, paymentData: any) =>
    api.put(`/tuitions/${id}/pay`, paymentData),
...
export const reportApi = {
  getStudentReport: (params: any) =>
    api.get("/reports/student_report", { params }),
  getAttendanceReport: (params: any) =>
    api.get("/reports/attendance_report", { params }),
  getFinancialReport: (params: any) =>
    api.get("/reports/financial_report", { params }),
  getGradesReport: (params: any) =>
    api.get("/reports/grades_report", { params }),
};
...
export const academicTermApi = {
  ...
  create: (data: Partial<AcademicTerm>) =>
    api.post<AcademicTerm>("/academic_terms", data),
  update: (id: number, data: Partial<AcademicTerm>) =>
    api.put<AcademicTerm>(`/academic_terms/${id}`, data),
...
export const educationLevelApi = {
  ...
  create: (data: Partial<EducationLevel>) =>
    api.post<EducationLevel>("/education_levels", data),
  update: (id: number, data: Partial<EducationLevel>) =>
    api.put<EducationLevel>(`/education_levels/${id}`, data),
...
export const gradeLevelApi = {
  getAll: (params?: any) => {
    ...
    return api
      .get<GradeLevel[]>("/grade_levels", { params })
      .then((response) => {
  ...
  create: (data: Partial<GradeLevel>) => {
    console.log("🐛 DEBUG - gradeLevelApi.create payload:", {
      grade_level: data,
    });
    return api.post<GradeLevel>("/grade_levels", { grade_level: data });
  },
  update: (id: number, data: Partial<GradeLevel>) => {
    console.log("🐛 DEBUG - gradeLevelApi.update payload para ID", id, ":", {
      grade_level: data,
    });
...
export const diaryApi = {
  ...
  update: (id: number, data: Partial<Diary>) => {
    console.log("🐛 DEBUG - diaryApi.update payload para ID", id, ":", {
      diary: data,
    });
  ...
  getStatistics: (id: number) =>
    api.get<DiaryStatistics>(`/diaries/${id}/statistics`),
  getGrades: (id: number) =>
    api.get<any[]>(`/grades`, { params: { diary_id: id } }),
  getOccurrences: (id: number, date?: string) =>
    api.get<any[]>(`/diaries/${id}/occurrences`, {
      params: date ? { date } : {},
    }),
  ...
  updateAttendances: (
    ...
    console.log(
      "API call to:",
      `/diaries/${diaryId}/lessons/${lessonId}/update_attendances`,
    );
    return api.put(
      `/diaries/${diaryId}/lessons/${lessonId}/update_attendances`,
      { attendances },
...
export const financialTransactionApi = {
  getAll: (filters?: FinancialTransactionFilters) =>
    api.get<FinancialTransactionResponse>("/financial_transactions", {
      params: filters,
    }),

  getById: (id: number) =>
    api.get<{ transaction: FinancialTransaction }>(
      `/financial_transactions/${id}`,
    ),

  create: (data: Partial<FinancialTransaction>) =>
    api.post<{ transaction: FinancialTransaction }>("/financial_transactions", {
      financial_transaction: data,
    }),

  update: (id: number, data: Partial<FinancialTransaction>) =>
    api.put<{ transaction: FinancialTransaction }>(
      `/financial_transactions/${id}`,
      { financial_transaction: data },
    ),

  delete: (id: number) => api.delete(`/financial_transactions/${id}`),

  pay: (id: number, paymentData: PaymentRequest) =>
    api.put<{ transaction: FinancialTransaction; message: string }>(
      `/financial_transactions/${id}/pay`,
      paymentData,
    ),
  ...
  generateCoraInvoice: (id: number) =>
    api.post<{
      ...
      coraInvoice: any;
    }>(`/financial_transactions/${id}/generate_cora_invoice`),
  ...
  bulkCreateTuitions: (month: number, year: number, amount: number) =>
    api.post<BulkCreateResponse>(
      "/financial_transactions/bulk_create_tuitions",
      { month, year, amount },
    ),

  bulkCreateSalaries: (month: number, year: number) =>
    api.post<BulkCreateResponse>(
      "/financial_transactions/bulk_create_salaries",
      { month, year },
    ),

  // Statistics
  getStatistics: (year?: number, month?: number) =>
    api.get<{ stats: any }>("/financial_transactions/statistics", {
      params: { year, month },
    }),
};
...
export const coraInvoiceApi = {
  ...
  getById: (id: number) => api.get<{ invoice: any }>(`/cora_invoices/${id}`),
  ...
  cancel: (id: number) =>
    api.patch<{ success: boolean; message: string; invoice: any }>(
      `/cora_invoices/${id}/cancel`,
    ),
...
export const adminApi = {
  ...
  students: {
    ...
    update: (id: number, data: any) =>
      api.put(`/admin/students/${id}`, { student: data }),
  ...
  guardians: {
    ...
    update: (id: number, data: any) =>
      api.put(`/admin/guardians/${id}`, { guardian: data }),
  ...
  users: {
    ...
    update: (id: number, data: any) =>
      api.put(`/admin/users/${id}`, { user: data }),
    delete: (id: number) => api.delete(`/admin/users/${id}`),
    changeRole: (id: number, role: string) =>
      api.put(`/admin/users/${id}/change_role`, { role }),
  ...
  classes: {
    ...
    create: (data: any) => {
      console.log("🐛 DEBUG - adminApi.classes.create payload:", {
        school_class: data,
      });
    ...
    update: (id: number, data: any) => {
      console.log(
        "🐛 DEBUG - adminApi.classes.update payload para ID",
        id,
        ":",
        { school_class: data },
      );
    ...
    bulkAddStudents: (id: number, studentIds: number[]) =>
      api.post(`/admin/classes/${id}/bulk_add_students`, {
        student_ids: studentIds,
      }),
    removeStudent: (id: number, studentId: number) =>
      api.delete(`/admin/classes/${id}/remove_student`, {
